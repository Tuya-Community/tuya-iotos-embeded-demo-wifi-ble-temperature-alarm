 ...
 * @Description: temperature alarm demo for SDK WiFi & BLE for BK7231N
 * @Copyright: HANGZHOU TUYA INFORMATION TECHNOLOGY CO.,LTD
 * @Company: http://www.tuya.com
 * @Date: 2021-02-22 15:10:00
 * @LastEditTime: 2021-05-26 15:38:15
 */
...
/* 使用 uart2 打印日志，波特率调整为9600 */
#define	ENABLE_UART_2_PRINT
/* wifi 相关配置 */
...
OPERATE_RET device_init(VOID_T) 
{
    ...
    op_ret = app_temper_alarm_init(APP_NORMAL);
    if(OPRT_OK != op_ret) {
        PR_ERR("app init err!");
        return op_ret;
    }
